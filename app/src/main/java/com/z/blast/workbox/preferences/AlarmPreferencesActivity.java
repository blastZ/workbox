 ...
 */
package com.z.blast.workbox.preferences;
...
import com.z.blast.workbox.Alarm;
import com.z.blast.workbox.BaseActivity;
import com.z.blast.workbox.R;
import com.z.blast.workbox.database.Database;
import com.z.blast.workbox.preferences.AlarmPreference.Key;
...
public class AlarmPreferencesActivity extends BaseActivity {
		...
		getListView().setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> l, View v, int position, long id) {
				...
				case STRING:
					...
					// com.z.blast.workbox.alert.setMessage(message);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.alarmmenu,menu);
		...
		case R.id.menu_item_delete:
			...
			dialog.setPositiveButton("Ok", new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Database.init(getApplicationContext());
					if (getMathAlarm().getId() < 1) {
						// com.z.blast.workbox.Alarm not saved
					} else {
