package com.z.blast.workbox;/* Copyright 2014 Sheldon Neilson www.neilson.co.za
 *
...
import com.z.blast.workbox.preferences.AlarmPreferencesActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mathAlarmListView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
				view.performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);//如果手机开启了触感反馈 就申请一次长按的触感反馈
